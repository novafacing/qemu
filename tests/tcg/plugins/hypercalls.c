...
static int32_t aarch64_hypercall_nr_cb(GByteArray *insn) {
    ...
    static const uint8_t hypercall_insns[AARCH64_N_HYPERCALL_INSNS][AARCH64_HYPERCALL_INSN_LEN] = {
        { 0xaa, 0x4, 0x0, 0x84 },
    { 0xaa, 0x5, 0x0, 0xa5 },
    { 0xaa, 0x6, 0x0, 0xc6 },
    { 0xaa, 0x7, 0x0, 0xe7 },
...
static int32_t arm_hypercall_nr_cb(GByteArray *insn) {
    ...
    static const uint8_t hypercall_insns[ARM_N_HYPERCALL_INSNS][ARM_HYPERCALL_INSN_LEN] = {
        { 0xe1, 0x84, 0x40, 0x4 },
    { 0xe1, 0x85, 0x50, 0x5 },
    { 0xe1, 0x86, 0x60, 0x6 },
    { 0xe1, 0x87, 0x70, 0x7 },
...
static const struct HypercallSpec hypercall_specs[] = {
    ...
    { false, "alpha", true,  { NULL, NULL, NULL, NULL}, NULL},
    { true, "arm", true,  {
            "r0", "r1", "r2", "r3",
    ...
    { false, "loongarch64", true,  { NULL, NULL, NULL, NULL }, NULL },
    { false, "m68k", false,  { NULL, NULL, NULL, NULL }, NULL },
    { false, "microblaze", false,  { NULL, NULL, NULL, NULL }, NULL },
    { false, "microblazeel", true,  { NULL, NULL, NULL, NULL }, NULL },
    { false, "mips", false,  { NULL, NULL, NULL, NULL }, NULL },
    { false, "mips64", false,  { NULL, NULL, NULL, NULL }, NULL },
    { false, "mips64el", true,  { NULL, NULL, NULL, NULL }, NULL },
    { false, "mipsel", true,  { NULL, NULL, NULL, NULL }, NULL },
    { false, "mipsn32", false,  { NULL, NULL, NULL, NULL }, NULL },
    { false, "mipsn32el", true,  { NULL, NULL, NULL, NULL }, NULL },
    { false, "or1k", false,  { NULL, NULL, NULL, NULL }, NULL },
    { false, "ppc", false,  { NULL, NULL, NULL, NULL }, NULL },
    { false, "ppc64", false,  { NULL, NULL, NULL, NULL }, NULL },
    { false, "ppc64le", true,  { NULL, NULL, NULL, NULL }, NULL },
    { false, "riscv32", true,  { NULL, NULL, NULL, NULL }, NULL },
    { false, "riscv64", true,  { NULL, NULL, NULL, NULL }, NULL },
    { false, "rx", true,  { NULL, NULL, NULL, NULL }, NULL },
    { false, "s390x", false,  { NULL, NULL, NULL, NULL }, NULL },
    { false, "sh4", true,  { NULL, NULL, NULL, NULL }, NULL },
    { false, "sh4eb", false,  { NULL, NULL, NULL, NULL }, NULL },
    { false, "sparc", false,  { NULL, NULL, NULL, NULL }, NULL },
    { false, "sparc32plus", false,  { NULL, NULL, NULL, NULL }, NULL },
    { false, "sparc64", false,  { NULL, NULL, NULL, NULL }, NULL },
    { false, "tricore", true,  { NULL, NULL, NULL, NULL }, NULL },
    { true, "x86_64", true, {
            "rdi", "rsi", "rdx", "rcx"

        }, x86_64_hypercall_nr_cb, x86_64_is_hypercall_cb
    },
    { false, "xtensa", true,  {NULL, NULL, NULL, NULL}, NULL},
    { false, "xtensaeb", false,  {NULL, NULL, NULL, NULL}, NULL},
...
static void hypercall(unsigned int vcpu_index, void *userdata)
{
    ...
    for (size_t i = 0; i < N_HYPERCALL_ARGS; i++) {
        ...
        struct qemu_plugin_register *reg = get_register(hypercall_spec->args[i]);
    ...
    for (size_t i = 0; i < qemu_plugin_tb_n_insns(tb); i++) {
        ...
        if (hypercall_spec->is_hypercall_cb(insn_data)) {
            ...
            qemu_plugin_register_vcpu_insn_exec_cb(insn, hypercall,
                                                   QEMU_PLUGIN_CB_R_REGS, (void *)insn_data);
        } else {
...
static void atexit_cb(qemu_plugin_id_t id, void *userdata) {
    for (size_t i = 0; i < hypercall_insns->len; i++) {
        g_byte_array_free(g_array_index(hypercall_insns, GByteArray *, i), true);
    }
